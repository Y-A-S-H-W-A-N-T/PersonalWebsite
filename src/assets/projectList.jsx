const Proj = [
    ...
    },
    {
        ...
        Skills: [1,2,0,7,6,8,16,11],
        Project_Link : 'https://vr-project-livid.vercel.app',
        hosted: true
    },
    {
        name: 'Harry Potter Cursed Child',
        description: `Welcome to our e-book edition of "Harry Potter and the Cursed Child"! Immerse yourself in the magical journey of Harry, Hermione, Ron, and their children with the convenience of our divided four-part format. Seamlessly navigate through the captivating storyline at your fingertips, as each click transports you deeper into the wizarding world. Whether you're a devoted fan revisiting the enchanting realm or a newcomer eager to experience its wonders for the first time, our e-book provides an accessible gateway to the timeless tale. Experience the thrill of adventure and the power of friendship as you embark on this unforgettable literary adventure with us.
        `,
        Skills: [16,5],
