const Proj = [
    ...
    },
    {
        id: 2,
        name: 'Welling',
        description: `Introducing a cutting-edge NEXT JS translator. This innovative tool utilizes speech recognition technology, allowing users to effortlessly translate between languages, aiding in job places, schools, colleges and language learning endeavors. With the ability to convert speech to text and provide English translations, this translator enhances accessibility and comprehension for users. Its intuitive interface empowers individuals navigating new environments to communicate effectively and adapt seamlessly. Simplify transitions and unlock opportunities with this user-friendly language conversion solution. Experience seamless communication with our Next.js translator, powered by Rapid API integration for lightning-fast performance. Easily translate messages in real-time, facilitating effortless communication across languages. Our translator leverages Next.js for optimized frontend rendering, ensuring a smooth and responsive user experience. `,
        Skills: [0,1,2,6,7,8,12],
        Project_Link : 'www.google.com'
    },
    {
